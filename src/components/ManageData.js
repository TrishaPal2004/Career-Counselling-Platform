...
const TableauDashboard = () => {
  ...
  const initViz = () => {
    ...
    const url = "https://public.tableau.com/views/ManagementDashboard_17254610172920/Dashboard1?:language=en-US&:sid=&:redirect=auth&:display_count=n&:origin=viz_share_link";
    const options = {
  ...
  return (
    <div>
      <h2 style={{color: 'white'}}>AIM ? Heres some choices for you !</h2>
      {isApiLoaded ? (
        <div
          ref={vizContainerRef}
